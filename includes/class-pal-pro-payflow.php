...
class Pal_Pro_Payflow {
    ...
    public function __construct() {
        ...
        add_filter("{$prefix}plugin_action_links_" . PAYPAL_PAYFLOW_PLUGIN_BASENAME, array($this, 'paypal_payflow_plugin_action_links'), 10, 4);
    }
    ...
    public function paypal_payflow_plugin_action_links($actions, $plugin_file, $plugin_data, $context) {
        $custom_actions = array(
            'configure' => sprintf('<a href="%s">%s</a>', admin_url('admin.php?page=wc-settings&tab=checkout&section=pal_pro_payflow'), __('Configure', 'donation-button')),
            'docs' => sprintf('<a href="%s" target="_blank">%s</a>', 'https://www.premiumdev.com/product/paypal-pro-payflow-for-woocommerce/', __('Docs', 'donation-button')),
            'support' => sprintf('<a href="%s" target="_blank">%s</a>', 'https://wordpress.org/support/plugin/woo-paypal-payflow', __('Support', 'donation-button')),
            'review' => sprintf('<a href="%s" target="_blank">%s</a>', 'https://wordpress.org/support/view/plugin-reviews/woo-paypal-payflow', __('Write a Review', 'donation-button')),
        );
